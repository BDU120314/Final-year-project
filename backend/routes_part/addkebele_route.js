...
const { AddKebele, GetKebele, GetSingleKebele, UpdateKebele, DeleteKebele, selectkebeleById, GetKebeleByWoredaId } = require("../controllers/addkebele_controllers");
const addkebele_router = express.Router();
 ...
 addkebele_router.get("/fetch/:id", GetKebeleByWoredaId);
