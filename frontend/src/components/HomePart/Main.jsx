    ...
    <div className=" ">
      <div className="  ">
        <div className="mb-16 text-center">
          <h2 className="  font-semibold tracking-wide text-indigo-600 uppercase text-3xl">
        ...
        <div className="flex flex-wrap my-12 dark:text-white">
          ...
          <div className="w-full p-8 border-b md:w-1/2 md:border-r lg:w-1/3 lg:border-r-0">
            <div className="flex items-center mb-6">
              <img src={download} alt="New" className="h-[100px] w-[100px]" />
          ...
          <div className="w-full p-8 border-b md:w-1/2 lg:w-1/3 lg:border-r lg:border-b-0">
            <div className="flex items-center mb-6">
            <img src={chemical_fertilizer} alt="" className="h-[100px] w-[100px] rounded-md" />
          ...
          <div className="w-full p-8 border-b md:w-1/2 md:border-r md:border-b-0 lg:w-1/3 lg:border-b-0">
            <div className="flex items-center mb-6">
              <img src={urea} alt="" className="h-[100px] w-[100px] rounded-md" />
