...
const Foooter = () => {
  return (
    <footer className="bg-gray-700 dark:bg-gray-800 pt-0 pb-0 xl:pt-8">
      <div className="max-w-screen-lg px-0 mx-auto text-gray-400 xl:max-w-screen-xl sm:px-2 md:px-2 dark:text-gray-300">
        <ul className="flex flex-wrap justify-center pb-2 text-lg font-light">
          <li className="w-1/2 md:w-1/3 lg:w-1/3">
            <div className="text-center">
              <h2 className="text-gray-500 dark:text-gray-200 text-md uppercase mb-0">
               Contacts
              </h2>
              <ul>
                <li className="mb-1 transition-colors duration-200 hover:text-gray-800 dark:hover:text-white">
          ...
          <li className="w-1/2 md:w-1/3 lg:w-1/3">
            <div className="text-center">
              <h2 className="text-gray-500 dark:text-gray-200 text-md uppercase mb-1">
               Social Media
              </h2>
              <ul>
                <li className="mb-1 transition-colors duration-200 hover:text-gray-800 dark:hover:text-white">
